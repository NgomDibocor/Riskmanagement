({
                                ...
                                actionUncertainty.setCallback(this, function(response) {
                                    ...
                                    if (state === 'SUCCESS') {
                                        ...
                                        actionUser.setCallback(this, function(response) {
                                            ...
                                            if (state === 'SUCCESS') {
                                                var noneUSer = {};
                                                noneUSer.sobjectType = 'User';
                                                noneUSer.Name = '--None--';
                                                noneUSer.Id = '';
                                                var allRiskManager = [];
                                                allRiskManager.push(noneUSer);
                                                component.set('v.allUser', allRiskManager.concat(response.getReturnValue()));
                                                //get AssessmentRisk
                                                ...
                                                actionGetAssessmentRisk.setCallback(this, function(response) {
                                                    ...
                                                    if (state === 'SUCCESS') {
                                                        ...
                                                        actionMT.setParams({
                                                            "assessmentRisk": component.get("v.assessmentRiskData").Id
                                                        });
    ...
    getBusinessImpacts: function(component, event) {
        ...
        actionGetBusinessImpacts.setParams({
            "assessment": component.get("v.assessmentData").Id
        });
    ...
    getSliderDefault: function(component, event, helper) {
        if (component.get("v.hsseImpacts").length == 0) {} else {
