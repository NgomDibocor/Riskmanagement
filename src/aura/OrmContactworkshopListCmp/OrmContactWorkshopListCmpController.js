...
// start pagination
		...
		// get size of all the records and then hold into an attribute
		// "totalRecords"
	...
	getselectedRows: function(component, event, helper) {
		...
		console.log('selectedRowsEvent'+event.getParam('selectedRows'));
		var tempselect=[];
	 ...
	 * @history 2018-09-27 : Salimata NGOM - Implementation
	 */
	 ...
	 * @history 2018-10-05 : Salimata NGOM - Implementation
	 */
