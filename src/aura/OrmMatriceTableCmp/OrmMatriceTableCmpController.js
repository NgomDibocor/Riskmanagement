				       ...
				       for (var i = 0; i < dataList.length; i++){
						    ...
						    // health and safety
							   if(dataList[i].orm_healthAndSafety__c == 'Low'){
							      ...
							      //var mapHS11 = component.get("v.mapHS11");
							      //mapHS11[dataList[i].orm_assessmentRisk__c] = "yellow";
							      //var st = dataList[i].orm_assessmentRisk__c];
                                  //mapHS11.set(, 'yellow');
                                  //alert(JSON.stingify(component.get("v.mapHS11")))
